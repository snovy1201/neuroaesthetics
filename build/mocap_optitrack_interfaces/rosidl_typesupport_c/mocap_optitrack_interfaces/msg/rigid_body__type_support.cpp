...
static const _RigidBody_type_support_symbol_names_t _RigidBody_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mocap_optitrack_interfaces, msg, RigidBody)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mocap_optitrack_interfaces, msg, RigidBody)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mocap_optitrack_interfaces, msg, RigidBody)() {
  return &::mocap_optitrack_interfaces::msg::rosidl_typesupport_c::RigidBody_message_type_support_handle;
}
