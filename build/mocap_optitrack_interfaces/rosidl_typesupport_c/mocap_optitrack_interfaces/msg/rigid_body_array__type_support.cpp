...
static const _RigidBodyArray_type_support_symbol_names_t _RigidBodyArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mocap_optitrack_interfaces, msg, RigidBodyArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mocap_optitrack_interfaces, msg, RigidBodyArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mocap_optitrack_interfaces, msg, RigidBodyArray)() {
  return &::mocap_optitrack_interfaces::msg::rosidl_typesupport_c::RigidBodyArray_message_type_support_handle;
}
